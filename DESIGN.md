...
- **Hero On This Day chiếm hết bề ngang và cao theo size class**: **180 (compact) → 260 (regular)** (`CollectionsHeroMetrics.height`), `@ScaledMetric` đặt ở màn chứ không ở thẻ. Cùng lý do §10.1d: thẻ là một *bức ảnh có chữ đè lên*, và ở 1032pt thì 150pt cao là một dải letterbox chứ không phải một bức ảnh. Section "Recents" riêng bị bỏ.
