...
- **Track có màu** cho Temp, Tint, **Saturation và Vibrance** (`EditorTheme.troughGradient`): xám ở trái chạy sang đủ màu ở phải. Track màu thì bỏ phần fill accent — màu **là** nghĩa của slider đó.
